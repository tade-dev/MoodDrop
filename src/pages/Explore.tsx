  ...
  return (
    <ScrollArea className="h-screen">
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 p-4 md:p-6 max-w-7xl mx-auto pt-16 md:pt-6">
          {/* Header */}
          <div className="mb-6 md:mb-8 animate-fade-in">
            ...
            <p className="text-gray-400 text-base md:text-lg">Discover trending moods, hot drops, and new music</p>
          </div>
          ...
          <section className="mb-8 md:mb-12 animate-fade-in" style={{ animationDelay: '0.1s' }}>
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              <TrendingUp className="w-5 h-5 md:w-6 md:h-6 text-purple-400" />
              <h2 className="text-xl md:text-2xl font-bold text-white">Trending Moods</h2>
          ...
          <section className="mb-8 md:mb-12 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-white">Hot Drops</h2>
          ...
          {/* Playlist Spotlight */}
          <section className="mb-8 md:mb-12 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              <Star className="w-5 h-5 md:w-6 md:h-6 text-yellow-400" />
              <h2 className="text-xl md:text-2xl font-bold text-white">Playlist Spotlight</h2>
          ...
          {/* Nearby Vibes */}
          {userLocation && (
            <section className="mb-8 md:mb-12 animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <div className="flex items-center gap-3 mb-4 md:mb-6">
                <MapPin className="w-5 h-5 md:w-6 md:h-6 text-green-400" />
                <h2 className="text-xl md:text-2xl font-bold text-white">Nearby Vibes</h2>
          ...
          {/* Creator Leaderboard */}
          <section className="mb-8 md:mb-12 animate-fade-in" style={{ animationDelay: '0.5s' }}>
            <div className="flex items-center gap-3 mb-4 md:mb-6">
              <Users className="w-5 h-5 md:w-6 md:h-6 text-blue-400" />
              <h2 className="text-xl md:text-2xl font-bold text-white">Creator Leaderboard</h2>
